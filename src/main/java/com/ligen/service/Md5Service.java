...
public class Md5Service {
    ...
    public String md5(String no, Integer count) {
        ...
        for (JSONObject data : dataList) {
            ...
            String md5 = MD5(numbers.substring(0, 4));
            sb.append("<p>期数:").append(dataNo).append("   号码:").append(numbers).append("   32位md5:").append(md5).append("   16位md5").append(md5.substring(8, 24)).append("</p>");
        }
        return sb.toString();
    }
